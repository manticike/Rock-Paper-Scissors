...
//   game();
   ...
   function playOneGame(playerClick, computerClick) {
        playerClick = rock;

    computerClick = getComputerChoice();
    // When the player selects rock
    if (playerClick.toLowerCase() === "rock" && computerClick === "paper") {
        computerScore +=1;
        return console.log(`You Lose! Paper beats Rock. You chose ${playerClick} and computer chose ${computerClick}`);  
    }
    
    else if (playerClick.toLowerCase() === "rock" && computerClick === "scissors") {
        playerScore += 1;
        return console.log(`You Win! Rock Smashes Scissors. You chose ${playerClick} and computer chose ${computerClick}`);    
    } 
    else if (playerClick.toLowerCase() === computerClick.toLowerCase()){ 
        return console.log(`It's a tie! You chose ${playerClick} and computer chose ${computerClick}`);
    }
}
